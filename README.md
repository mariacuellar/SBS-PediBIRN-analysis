...
- [<span class="toc-section-number">8</span> Questions for
  Chris](#questions-for-chris)
...
- What exactly was the intervention being tested in the PediBIRN
  intervention sites?
- For the clustering analysis, is it appropriate to combine the
  intervention and control patients into a single analysis dataset,
  given that the goal is to study the underlying patient injury patterns
